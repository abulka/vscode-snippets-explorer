...
class ExtensionPathInfo {
    ...
    analyse() {
        ...
        // This later version is more robust, and handles the case where the
        // extensionId has a platform and architecture suffix e.g.
        // '-darwin-arm64'
        const match = this.fullPath.match(/.*\/extensions\/([^\/]+?)(?:-([\d\.]+))?(?:-[a-zA-Z0-9-]+)?\/snippets\/(.*)/);
