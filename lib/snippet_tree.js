...
type Snippet = {
    // Define the structure of a single snippet
    prefix: string;
    body: string | string[];
    description?: string;
};
...
type LanguageIdTree = {
    snippetTree: any; // Replace 'any' with the actual type of snippetTree
...
class TreeDataProvider {
    ...
    // where Map string is the label of the tree item, and boolean is whether it is expanded or not
...
class TreeDataProvider {
    ...
    constructor() {
        ...
        this.languageIdTrees = {}; // Store snippetTree and treeviewItems trees per languageId
    ...
    async _buildTree(languageId) {
        ...
        if (languageId == undefined) {
            ...
            this.data = [new TreeItem("No snippets available, please open a file.", 1, [], undefined, vscode.TreeItemCollapsibleState.None)];
            return;
        }
