...
class TreeDataProvider {
    ...
    async addLanguage(languageId) {
        if (Object.keys(this.snippetTree).includes(languageId)) {
            // A good optimisation, actually. Won't rebuild the tree if the language already exists in the tree
            vscode.window.showInformationMessage(`Language '${languageId}' already exists in snippets tree`);
        }
