...
class TreeDataProvider {
    ...
    async _buildTree(languageId) {
        ...
        for (const [_languageId, languageSnippets] of Object.entries(
            ...
            let languageTreeItem = new TreeItem(_languageId, [], undefined, vscode.TreeItemCollapsibleState.Expanded);
            ...
            for (const [fullPath, snippets] of Object.entries(languageSnippets)) {
                ...
                let kindTreeItem = new TreeItem(label, [], snippets._meta_.kind, vscode.TreeItemCollapsibleState.Collapsed);
